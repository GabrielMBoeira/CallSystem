            ...
            <form action="#" method="POST">
                <div class="form-row mt-3">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="placa" class="form-control" style="text-transform: uppercase" value="<?= $dados['placa'] ?>">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="motorista">Motorista</label>
                        <input type="text" id="motorista" class="form-control" style="text-transform: uppercase" value="<?= $dados['motorista'] ?>">
                    </div>
                    <div class="form-group col-md-4">
